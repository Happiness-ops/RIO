...
var InsightsController = function () {
    var _classDecorators = [(0, common_1.Controller)('insights')];
    ...
    var InsightsController = _classThis = /** @class */ (function () {
        function InsightsController_1(insightsService) {
            this.insightsService = (__runInitializers(this, _instanceExtraInitializers), insightsService);
        }
        /** GET /v1/insights/daily */
        InsightsController_1.prototype.getDaily = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var insight;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.insightsService.getDaily(user.dbUserId)];
                        case 1:
                            insight = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Daily insight retrieved', insight)]; // data: null is valid
                    }
                });
            });
        };
        /** GET /v1/insights/history */
        InsightsController_1.prototype.getHistory = function (user, query) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.insightsService.getHistory(user.dbUserId, query)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Insight history retrieved', result)];
                    }
                });
            });
        };
        /** PATCH /v1/insights/:insightId/read */
        InsightsController_1.prototype.markRead = function (user, insightId) {
            return __awaiter(this, void 0, void 0, function () {
                var insight;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.insightsService.markRead(user.dbUserId, insightId)];
                        case 1:
                            insight = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Insight marked as read', insight)];
                    }
                });
            });
        };
        return InsightsController_1;
    }());
    __setFunctionName(_classThis, "InsightsController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _getDaily_decorators = [(0, common_1.Get)('daily')];
        _getHistory_decorators = [(0, common_1.Get)('history')];
        _markRead_decorators = [(0, common_1.Patch)(':insightId/read')];
