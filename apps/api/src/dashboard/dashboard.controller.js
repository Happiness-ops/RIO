...
var DashboardController = function () {
    var _classDecorators = [(0, common_1.Controller)('dashboard')];
    ...
    var DashboardController = _classThis = /** @class */ (function () {
        ...
        /** GET /v1/dashboard */
        DashboardController_1.prototype.getDashboard = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var dashboard;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.dashboardService.getDashboard(user.dbUserId)];
                        case 1:
                            dashboard = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Dashboard retrieved', dashboard)];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _getDashboard_decorators = [(0, common_1.Get)(), (0, throttler_1.Throttle)({ default: { ttl: 60000, limit: 60 } })];
