...
var RedisService = function () {
    ...
    var RedisService = _classThis = /** @class */ (function () {
        ...
        RedisService_1.prototype.onModuleInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    this.client.on('close', function () { return _this.logger.warn('Redis connection closed'); });
                    return [2 /*return*/];
                });
            });
        };
        ...
        RedisService_1.prototype.del = function () {
            var keys = [];
        ...
        //   );
        // ─────────────────────────────────────────────────────────────────────────
        RedisService_1.prototype.getOrSet = function (key, ttlSeconds, fetcher) {
            return __awaiter(this, void 0, void 0, function () {
                var cached, data;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        // ─────────────────────────────────────────────────────────────────────────
        RedisService_1.prototype.delPattern = function (pattern) {
            return __awaiter(this, void 0, void 0, function () {
                var cursor, _a, nextCursor, keys;
                var _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            _a = _c.sent(), nextCursor = _a[0], keys = _a[1];
                            cursor = nextCursor;
        ...
        // ─────────────────────────────────────────────────────────────────────────
        RedisService_1.prototype.blocklistJwt = function (jti, ttlSeconds) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.client.set("jwt:blocklist:".concat(jti), '1', 'EX', ttlSeconds)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        RedisService_1.prototype.isJwtBlocklisted = function (jti) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.exists("jwt:blocklist:".concat(jti))];
                });
            });
        };
        // ─────────────────────────────────────────────────────────────────────────
        ...
        // ─────────────────────────────────────────────────────────────────────────
        RedisService_1.prototype.setHeartbeat = function (userId_1, tabId_1) {
            return __awaiter(this, arguments, void 0, function (userId, tabId, ttlSeconds) {
                if (ttlSeconds === void 0) { ttlSeconds = 600; }
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.client.set("session:".concat(userId, ":").concat(tabId), Date.now().toString(), 'EX', ttlSeconds)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
