                        ...
                        case 1:
                            ...
                            if (process.env.NODE_ENV === 'development') {
                                ...
                                this.$on('query', function (e) {
                                    if (e.duration > 200) {
                                        _this.logger.warn("Slow query (".concat(e.duration, "ms): ").concat(e.query));
                                    }
                                });
                            }
                            ...
                            this.$on('error', function (e) {
                                _this.logger.error('Prisma error', e);
                            });
                            return [2 /*return*/];
                    }
                });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            table = tables_1[_i];
                            return [4 /*yield*/, this.$executeRawUnsafe("TRUNCATE TABLE \"".concat(table, "\" CASCADE"))];
                        case 2:
                            _a.sent();
                            _a.label = 3;
                        case 3:
