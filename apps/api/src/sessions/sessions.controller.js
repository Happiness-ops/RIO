...
var SessionsController = function () {
    var _classDecorators = [(0, common_1.Controller)('sessions')];
    ...
    var SessionsController = _classThis = /** @class */ (function () {
        function SessionsController_1(sessionsService) {
         ...
         */
        SessionsController_1.prototype.heartbeat = function (user, tabId) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.sessionsService.heartbeat(user.dbUserId, tabId !== null && tabId !== void 0 ? tabId : 'unknown')];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Heartbeat received', result)];
                    }
                });
            });
        };
         ...
         */
        SessionsController_1.prototype.logout = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.sessionsService.logout(user.dbUserId, user.jti, user.exp)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Logged out successfully', null)];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _heartbeat_decorators = [(0, common_1.Post)('heartbeat'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, throttler_1.Throttle)({ default: { ttl: 60000, limit: 5 } })];
        _logout_decorators = [(0, common_1.Delete)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
