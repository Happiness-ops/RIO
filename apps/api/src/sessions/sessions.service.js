...
var SessionsService = function () {
    ...
    var SessionsService = _classThis = /** @class */ (function () {
        function SessionsService_1(redis) {
            this.redis = redis;
        }
        /** Keep the session alive — resets the 10-minute Redis TTL */
        SessionsService_1.prototype.heartbeat = function (userId, tabId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.redis.setHeartbeat(userId, tabId, 600)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, { alive: true, nextHeartbeatMs: 5 * 60 * 1000 }];
                    }
                });
            });
        };
        /** Logout — blocklist the JWT so it's rejected on all future requests */
        SessionsService_1.prototype.logout = function (userId, jti, exp) {
            return __awaiter(this, void 0, void 0, function () {
                var ttl;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!jti) return [3 /*break*/, 2];
                            ttl = exp - Math.floor(Date.now() / 1000);
                            if (!(ttl > 0)) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.redis.blocklistJwt(jti, ttl)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: 
                        // Remove all active heartbeat keys for this user
                        return [4 /*yield*/, this.redis.delPattern("session:".concat(userId, ":*"))];
                        case 3:
                            // Remove all active heartbeat keys for this user
                            _a.sent();
                            return [2 /*return*/];
