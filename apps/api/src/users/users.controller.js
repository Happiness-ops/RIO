...
var UsersController = function () {
    ...
    var _getBehavioralSnapshot_decorators;
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.getProfile = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.getProfile(user.dbUserId)];
                        case 1:
                            profile = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Profile retrieved', profile)];
                    }
                });
            });
        };
        ...
        UsersController_1.prototype.updateProfile = function (user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.updateProfile(user.dbUserId, dto)];
                        case 1:
                            profile = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Profile updated', profile)];
                    }
                });
            });
        };
        /** GET /v1/users/me/behavioral-snapshot  (Epic 8) */
        UsersController_1.prototype.getBehavioralSnapshot = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var snapshot;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.getBehavioralSnapshot(user.dbUserId)];
                        case 1:
                            snapshot = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Behavioral snapshot retrieved', snapshot)];
                    }
                });
            });
        };
        /** DELETE /v1/users/me */
        UsersController_1.prototype.deleteAccount = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.deleteAccount(user.dbUserId)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Account scheduled for deletion', null)];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _updateProfile_decorators = [(0, common_1.Patch)('me/profile')];
        _getBehavioralSnapshot_decorators = [(0, common_1.Get)('me/behavioral-snapshot')];
        _deleteAccount_decorators = [(0, common_1.Delete)('me'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, throttler_1.Throttle)({ default: { ttl: 3600000, limit: 3 } })];
        ...
        __esDecorate(_classThis, null, _getBehavioralSnapshot_decorators, { kind: "method", name: "getBehavioralSnapshot", static: false, private: false, access: { has: function (obj) { return "getBehavioralSnapshot" in obj; }, get: function (obj) { return obj.getBehavioralSnapshot; } }, metadata: _metadata }, null, _instanceExtraInitializers);
