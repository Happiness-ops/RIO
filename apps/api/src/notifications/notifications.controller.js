...
var NotificationsController = function () {
    var _classDecorators = [(0, common_1.Controller)('notifications/web-push')];
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.subscribe = function (user, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.notificationsService.subscribe(user.dbUserId, dto)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Push subscription registered', result)];
                    }
                });
            });
        };
        /** GET /v1/notifications/web-push/status */
        NotificationsController_1.prototype.getStatus = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var status;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.notificationsService.getStatus(user.dbUserId)];
                        case 1:
                            status = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Push status retrieved', status)];
                    }
                });
            });
        };
        /** DELETE /v1/notifications/web-push/subscribe */
        NotificationsController_1.prototype.unsubscribe = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.notificationsService.unsubscribe(user.dbUserId)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('Push subscription removed', null)];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _subscribe_decorators = [(0, common_1.Post)('subscribe'), (0, throttler_1.Throttle)({ default: { ttl: 5 * 60000, limit: 5 } })];
        _getStatus_decorators = [(0, common_1.Get)('status')];
        _unsubscribe_decorators = [(0, common_1.Delete)('subscribe'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
