...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
         ...
         */
        AuthController_1.prototype.sync = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.syncUser(dto.token)];
                        case 1:
                            user = _a.sent();
                            return [2 /*return*/, (0, response_helper_1.ok)('User synced successfully', user)];
                    }
                });
            });
        };
    ...
    (function () {
        ...
        _sync_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Post)('sync'), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, throttler_1.Throttle)({ default: { ttl: 60000, limit: 10 } })];
