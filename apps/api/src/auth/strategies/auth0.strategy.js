...
var Auth0Strategy = function () {
    ...
    var _classThis;
    var Auth0Strategy = _classThis = /** @class */ (function () {
        function Auth0Strategy_1() {
            this.logger = new common_1.Logger(Auth0Strategy.name);
        ...
        Auth0Strategy_1.prototype.verify = function (token) {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            ...
                            jwt.verify(token, getKey, {
                                ...
                                if (err) {
                                    _this.logger.warn("Auth0 token verification failed: ".concat(err.message));
                                    if (err.name === 'TokenExpiredError') {
                                        return reject(new common_1.UnauthorizedException('Token has expired — please log in again'));
                                    }
                                    return reject(new common_1.UnauthorizedException('Invalid Auth0 token'));
                                }
                                if (!(decoded === null || decoded === void 0 ? void 0 : decoded.email)) {
                                    return reject(new common_1.UnauthorizedException('Auth0 token must contain an email claim'));
                                }
                                resolve({
        ...
        return Auth0Strategy_1;
    }());
    __setFunctionName(_classThis, "Auth0Strategy");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        Auth0Strategy = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Auth0Strategy = _classThis;
}();
